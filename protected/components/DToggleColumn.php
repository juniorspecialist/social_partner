...
class DToggleColumn extends CGridColumn
{
     ...
     */
    public $titles = array(0=>'Не обработана',1=>'Обработана');
    /**
    ...
    public function init()
    {
        ...
        if (empty($this->onImageUrl))
            $this->onImageUrl = Yii::app()->createAbsoluteUrl('/images/yes.png');

        if (empty($this->offImageUrl))
            $this->offImageUrl = Yii::app()->createAbsoluteUrl('/images/no.png');
    ...
    protected function renderDataCellContent($row,$data)
    {
        ...
        if ($visible)
        {
            ...
            elseif ($this->linkUrl !== false)
             ...
             //echo '<pre>'; print_r($this->titles); die();
            ...
            if($value==1){
                ...
                //echo 'yes';
                echo CHtml::link('Подтвердить', $url, array('class'=>'toggle-link ' . $this->class . ($value ? ' toggle-true' : '')));
            }
