...
class JQRelcopy extends CWidget
{
	...
	public function init()
	{
		...
		if (!empty($this->removeText))
		{
			...
			$htmlOptions = array_merge($this->removeHtmlOptions,array('onclick'=>$onClick, 'class'=>'remove_link'));
			$append = '<div class="del_link"> '.CHtml::link($this->removeText,'#',$htmlOptions).'</div>';
