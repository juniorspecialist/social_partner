...
<div id="counters">
    ...
    <?
        ...
        if($childCountMember>0){
            echo $data->getAjaxlink('Подробнее '.$data->arrow,$this->createUrl('/admin/business/ajaxtbl'), array('Partner[type]'=>Partner::STATUS_MEMBER));
        }
    ?> <br>
    ...
    <?
        ...
        if($childCountPartner>0){
            echo $data->getAjaxlink('Подробнее '.$data->arrow,$this->createUrl('/admin/business/ajaxtbl'), array('Partner[type]'=>Partner::STATUS_Partner));
        }
    ...
    <?
        ...
        if($childCountPartnerLevel1>0){
            echo $data->getAjaxlink('Подробнее '.$data->arrow,$this->createUrl('/admin/business/ajaxtbl'), array('Partner[type]'=>-1));
        }
    ?>
</div>
<?
